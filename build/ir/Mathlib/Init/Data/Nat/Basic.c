...
// Imports: Init Mathlib.Init.ZeroOne Mathlib.Init.Data.Nat.Notation Mathlib.Util.CompileInductive
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Init_Data_Nat_Basic(uint8_t builtin, lean_object* w) {
lean_object * res;
