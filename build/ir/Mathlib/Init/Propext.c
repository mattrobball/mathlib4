...
// Module: Mathlib.Init.Propext
// Imports: Init Mathlib.Init.Logic Mathlib.Mathport.Rename
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Init_Propext(uint8_t builtin, lean_object* w) {
lean_object * res;
