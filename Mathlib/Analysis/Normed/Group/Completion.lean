...
@[simp]
theorem norm_coe {E} [AddCommGroup E] [SeminormedAddCommGroup E] (x : E) :
    ‖(x : Completion E)‖ = ‖x‖ :=
...
@[simp]
theorem nnnorm_coe {E} [AddCommGroup E] [SeminormedAddCommGroup E] (x : E) :
    ‖(x : Completion E)‖₊ = ‖x‖₊ := by
  simp [nnnorm]

@[simp]
lemma enorm_coe {E} [AddCommGroup E] [SeminormedAddCommGroup E] (x : E) :
    ‖(x : Completion E)‖ₑ = ‖x‖ₑ := by
  simp [enorm]
