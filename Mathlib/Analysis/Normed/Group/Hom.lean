...
variable {V W : Type*} [AddCommGroup V] [SeminormedAddCommGroup V]
  [AddCommGroup W] [SeminormedAddCommGroup W] {f g : NormedAddGroupHom V W}
...
variable {V V₁ V₂ V₃ : Type*} [AddCommGroup V] [SeminormedAddCommGroup V]
...
theorem toAddMonoidHom_injective :
    Function.Injective (NormedAddGroupHom.toAddMonoidHom : NormedAddGroupHom V₁ V₂ → V₁ →+ V₂) :=
  fun f g h => coe_inj <| by rw [← coe_toAddMonoidHom f, ← coe_toAddMonoidHom g, h]
...
theorem opNorm_zero_iff {V₁ V₂ : Type*} [AddCommGroup V₁] [NormedAddCommGroup V₁]
    [AddCommGroup V₂] [NormedAddCommGroup V₂] {f : NormedAddGroupHom V₁ V₂} : ‖f‖ = 0 ↔ f = 0 :=
  Iff.intro
    (fun hn =>
      ext fun x =>
        norm_le_zero_iff.1
...
theorem norm_id {V : Type*} [AddCommGroup V] [NormedAddCommGroup V] [Nontrivial V] :
    ‖id V‖ = 1 := by
...
instance toNormedAddCommGroup {V₁ V₂ : Type*} [AddCommGroup V₁] [NormedAddCommGroup V₁]
    [AddCommGroup V₂] [NormedAddCommGroup V₂] : NormedAddCommGroup (NormedAddGroupHom V₁ V₂) :=
...
variable {V W V₁ V₂ V₃ : Type*} [AddCommGroup V] [SeminormedAddCommGroup V]
  [AddCommGroup W] [SeminormedAddCommGroup W] [AddCommGroup V₁] [SeminormedAddCommGroup V₁]
  [AddCommGroup V₂] [SeminormedAddCommGroup V₂] [AddCommGroup V₃] [SeminormedAddCommGroup V₃]
...
theorem isClosed_ker {V₂ : Type*} [AddCommGroup V₂] [NormedAddCommGroup V₂]
    (f : NormedAddGroupHom V₁ V₂) : IsClosed (f.ker : Set V₁) :=
...
variable {W₁ W₂ W₃ : Type*} [AddCommGroup W₁] [SeminormedAddCommGroup W₁]
  [AddCommGroup W₂] [SeminormedAddCommGroup W₂] [AddCommGroup W₃] [SeminormedAddCommGroup W₃]
